...
const PROD_MESSAGING_ID = '282651260316'
...
firebase.initializeApp({
  ...
  messagingSenderId: !STAGE_MESSAGING_ID || self.location.hostname.includes('fir-functions-b96c5')
    ? PROD_MESSAGING_ID
    : STAGE_MESSAGING_ID
})
